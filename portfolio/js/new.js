! function(t) {
    ...
    */
            ...
            this.init = () => {
                ...
                if (!1 === this.active) {
                    ...
                    [...this.years].forEach(e => {
                        ...
                        ease: "expo.inOut",
                        onComplete: () => {
                            this.button.innerHTML = "â†‘ Show Less", gn.scroll.resize()
                        }
                    })
                    ...
                    onComplete: () => {
                        ...
                        gn.scroll.data.current = t, this.button.innerHTML = "â†“ Show More", gn.scroll.resize()
                    }
                })
    ...
    class En {
        ...
        init() {
            this.dom.page.classList.contains("is-contact") ? gn.offset = void 0 : (this.values(), this.set(), this.events())
        }
    }
    class Fn {
        constructor() {
